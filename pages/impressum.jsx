...
export default function impressum() {
  return (
    <Layout title="Impressum / Datenschutz">
      ...
      <div className="table">
        <div className="tr">
          <div className="td">Telefon: &nbsp;</div>
          <div className="td"> +49 (0) 123 44 55 66</div>
        </div>{' '}
        <div className="tr">
          <div className="td">Telefax: &nbsp;</div>
          <div className="td"> +49 (0) 123 44 55 99</div>
        </div>{' '}
        <div className="tr">
          <div className="td">E-Mail: &nbsp;</div>
          <div className="td"> mustermann@musterfirma.de</div>{' '}
        </div>
      </div>{' '}
      <p>
      ...
      <p>
        ...
        gespeichert, bis Sie diese l&ouml;schen. Diese Cookies erm&ouml;glichen
      ...
      <p>
        ...
        Diese Daten verwenden wir ausschlie&szlig;lich f&uuml;r den Versand der
      ...
      <p>
        ...
        jederzeit widerrufen, etwa &uuml;ber den &lsqo;Austragen&rsqo;-Link im
        Newsletter.
      </p>
      <p>&nbsp;</p>{' '}
      <h2>
      ...
      <p>
        Google Analytics verwendet so genannte &lsqo;Cookies&rsqo;. Das sind
      ...
      <p>
        ...
        auf dieser Webseite. Dadurch wird Ihre IP-Adresse von Google jedoch
        ...
        Wirtschaftsraum zuvor gek&uuml;rzt. Nur in Ausnahmef&auml;llen wird die
        volle IP-Adresse an einen Server von Google in den USA &uuml;bertragen
        und dort gek&uuml;rzt. Im Auftrag des Betreibers dieser Website wird
        ...
        Internetnutzung verbundene Dienstleistungen gegen&uuml;ber dem
        Websitebetreiber zu erbringen. Die im Rahmen von Google Analytics von
        Ihrem Browser &uuml;bermittelte IP-Adresse wird nicht mit anderen Daten
        von Google zusammengef&uuml;hrt.
      </p>{' '}
      <p>&nbsp;</p>
      ...
      <p>
        ...
        etracker GmbH, Erste Brunnenstra&szlig;e 1, 20459 Hamburg Germany. Aus
        den Daten k&ouml;nnen unter einem Pseudonym Nutzungsprofile erstellt
        werden. Dazu k&ouml;nnen Cookies eingesetzt werden. Bei Cookies handelt
        es sich um kleine Textdateien, die lokal im Zwischenspeicher Ihres
        ...
        identifizieren und werden nicht mit personenbezogenen Daten &uuml;ber
        den Tr&auml;ger des Pseudonyms zusammengef&uuml;hrt.
      </p>
      <p>
        ...
        Browsers bei etracker erhoben und gespeichert werden:{' '}
        <a href="http://www.etracker.de/privacy?et=V23Jbb">
          http://www.etracker.de/privacy?et=V23Jbb
        </a>
      </p>{' '}
      <p>
        Dadurch wird ein Opt-Out-Cookie mit dem Namen &lsqo;cntcookie&rsqo; von
        etracker gesetzt. Bitte l&ouml;schen Sie diesen Cookie nicht, solange
        Sie Ihren Widerspruch aufrecht erhalten m&ouml;chten. Weitere
        Informationen finden Sie in den Datenschutzbestimmungen von etracker:{' '}
        <a href="http://www.etracker.com/de/datenschutz.html">
          http://www.etracker.com/de/datenschutz.html
        </a>
      </p>
      <p>&nbsp;</p>{' '}
      <h2>Datenschutzerkl&auml;rung f&uuml;r die Nutzung von Piwik</h2>
      <p>
        Diese Website benutzt den Open Source Webanalysedienst Piwik. Piwik
        verwendet so genannte &lsqo;Cookies&rsqo;. Das sind Textdateien, die auf
        Ihrem Computer gespeichert werden und die eine Analyse der Benutzung der
        Website durch Sie erm&ouml;glichen. Dazu werden die durch den Cookie
        erzeugten Informationen &uuml;ber die Benutzung dieser Website auf
        unserem Server gespeichert. Die IP-Adresse wird vor der Speicherung
        anonymisiert.
      </p>{' '}
      <p>
        Die durch den Cookie erzeugten Informationen &uuml;ber die Benutzung
        dieser Website werden nicht an Dritte weitergegeben. Sie k&ouml;nnen die
      ...
      <p>
        ...
        sind, k&ouml;nnen Sie die Speicherung und Nutzung hier deaktivieren. In
        diesem Fall wird in Ihrem Browser ein Opt-Out-Cookie hinterlegt der
        verhindert, dass Piwik Nutzungsdaten speichert. Wenn Sie Ihre Cookies
        l&ouml;schen hat dies zur Folge, dass auch das Piwik Opt-Out-Cookie
        gel&ouml;scht wird. Das Opt-Out muss bei einem erneuten Besuch unserer
      ...
      <p>&nbsp;</p>{' '}
      <h2>
        Datenschutzerkl&auml;rung f&uuml;r die Nutzung von Facebook-Plugins
        (Like-Button)
      </h2>{' '}
      <p>
        ...
        dem &lsqo;Like-Button&rsqo; (&lsqo;Gef&auml;llt mir&rsqo;) auf unserer
      ...
      <p>
        ...
        &lsqo;Like-Button&rsqo; anklicken w&auml;hrend Sie in Ihrem Facebook-
        Account eingeloggt sind, k&ouml;nnen Sie die Inhalte unserer Seiten auf
      ...
      <p>
        ...
        Twitter und der Funktion &lsqo;Re-Tweet&rsqo; werden die von Ihnen
        besuchten Webseiten mit Ihrem Twitter-Account verkn&uuml;pft und anderen
        Nutzern bekannt gegeben. Dabei werden auch Daten an Twitter
        ...
        in der Datenschutzerkl&auml;rung von Twitter unter{' '}
      ...
      <p>
        ...
        ver&ouml;ffentlichen. &Uuml;ber die Google+-Schaltfl&auml;che erhalten
        Sie und andere Nutzer personalisierte Inhalte von Google und unseren
        Partnern. Google speichert sowohl die Information, dass Sie f&uuml;r
        einen Inhalt +1 gegeben haben, als auch Informationen &uuml;ber die
        Seite, die Sie beim Klicken auf +1 angesehen haben. Ihre +1 k&ouml;nnen
      ...
      <p>
        Google zeichnet Informationen &uuml;ber Ihre +1-Aktivit&auml;ten auf, um
        die Google-Dienste f&uuml;r Sie und andere zu verbessern. Um die
        Google+-Schaltfl&auml;che verwenden zu k&ouml;nnen, ben&ouml;tigen Sie
        ein weltweit sichtbares, &ouml;ffentliches Google-Profil, das zumindest
        den f&uuml;r das Profil gew&auml;hlten Namen enthalten muss. Dieser Name
        wird in allen Google-Diensten verwendet. In manchen F&auml;llen kann
        dieser Name auch einen anderen Namen ersetzen, den Sie beim Teilen von
        Inhalten &uuml;ber Ihr Google-Konto verwendet haben. Die Identit&auml;t
        Ihres Google-Profils kann Nutzern angezeigt werden, die Ihre
        E-Mail-Adresse kennen oder &uuml;ber andere identifizierende
        Informationen von Ihnen verf&uuml;gen.
      </p>{' '}
      <p>
        Verwendung der erfassten Informationen: Neben den oben erl&auml;uterten
        Verwendungszwecken werden die von Ihnen bereitgestellten Informationen
        gem&auml;&szlig; den geltenden Google-Datenschutzbestimmungen genutzt.
        Google ver&ouml;ffentlicht m&ouml;glicherweise zusammengefasste
        Statistiken &uuml;ber die +1-Aktivit&auml;ten der Nutzer bzw. gibt diese
        an Nutzer und Partner weiter, wie etwa Publisher, Inserenten oder
        verbundene Websites.
      </p>
      <p>&nbsp;</p>{' '}
      ...
      <p>
        ...
        enth&auml;lt, wird eine Verbindung zu Servern von LinkedIn aufbaut.
        LinkedIn wird dar&uuml;ber informiert, dass Sie unsere Internetseiten
        mit Ihrer IP-Adresse besucht haben. Wenn Sie den
        &lsqo;Recommend-Button&rsqo; von LinkedIn anklicken und in Ihrem Account
        bei LinkedIn eingeloggt sind, ist es LinkedIn m&ouml;glich, Ihren Besuch
        auf unserer Internetseite Ihnen und Ihrem Benutzerkonto zuzuordnen. Wir
        weisen darauf hin, dass wir als Anbieter der Seiten keine Kenntnis vom
        Inhalt der &uuml;bermittelten Daten sowie deren Nutzung durch LinkedIn
        haben.
      </p>{' '}
      <p>
        Weitere Informationen hierzu finden Sie in der Datenschutzerkl&auml;rung
      ...
      <p>
        ...
        CA 94103-490, USA (&lsqo;Pinterest&rsqo;) betrieben wird. Wenn Sie eine
        Seite aufrufen, die ein solches Plugin enth&auml;lt, stellt Ihr Browser
        eine direkte Verbindung zu den Servern von Pinterest her. Das Plugin
        &uuml;bermittelt dabei Protokolldaten an den Server von Pinterest in die
        USA. Diese Protokolldaten enthalten m&ouml;glicherweise Ihre IP-Adresse,
      ...
      <p>
        ...
        den den Datenschutzhinweisen von Pinterest:{' '}
        <a href="https://about.pinterest.com/de/privacy-policy">
          https://about.pinterest.com/de/privacy-policy
        </a>
      </p>
      <p>&nbsp;</p>{' '}
      <h2>Datenschutzerkl&auml;rung f&uuml;r die Nutzung von SoundCloud</h2>{' '}
      <p>
        Auf unseren Seiten k&ouml;nnen Plugins des sozialen Netzwerks SoundCloud
        (SoundCloud Limited, Berners House, 47-48 Berners Street, London W1T
        3NF, Gro&szlig;britannien.) integriert sein. Die SoundCloud-Plugins
      ...
      <p>
        ...
        hergestellt. SoundCloud erh&auml;lt dadurch die Information, dass Sie
        mit Ihrer IP-Adresse unsere Seite besucht haben. Wenn Sie den
        &quot;Like-Button&quot; oder &quot;Share-Button&quot; anklicken
        w&auml;hrend Sie in Ihrem SoundCloud- Benutzerkonto eingeloggt sind,
        k&ouml;nnen Sie die Inhalte unserer Seiten mit Ihrem SoundCloud-Profil
        verlinken und/oder teilen. Dadurch kann SoundCloud Ihrem Benutzerkonto
        den Besuch unserer Seiten zuordnen. Wir weisen darauf hin, dass wir als
        Anbieter der Seiten keine Kenntnis vom Inhalt der &uuml;bermittelten
        Daten sowie deren Nutzung durch SoundCloud erhalten. Weitere
      ...
      <p>
        Wenn Sie nicht w&uuml;nschen, dass Soundcloud den Besuch unserer Seiten
      ...
      <p>
        Unsere Webseite nutzt Funktionen des Netzwerks XING. Anbieter ist die
        XING AG, Dammtorstra&szlig;e 29-32, 20354 Hamburg, Deutschland. Bei
        jedem Abruf einer unserer Seiten, die Funktionen von XING enth&auml;lt,
        wird eine Verbindung zu Servern von XING hergestellt. Eine Speicherung
        von personenbezogenen Daten erfolgt dabei nach unserer Kenntnis nicht.
      ...
      <p>
        ...
        in der Datenschutzerkl&auml;rung von XING unter{' '}
      ...
      <p>
        Unsere Seiten nutzen Schaltfl&auml;chen des Dienstes Tumblr. Anbieter
        ist die Tumblr, Inc., 35 East 21st St, 10th Floor, New York, NY 10010,
        USA. Diese Schaltfl&auml;chen erm&ouml;glichen es Ihnen, einen Beitrag
        oder eine Seite bei Tumblr zu teilen oder dem Anbieter bei Tumblr zu
        folgen. Wenn Sie eine unserer Webseiten mit Tumblr-Button aufrufen, baut
        der Browser eine direkte Verbindung mit den Servern von Tumblr auf. Wir
        haben keinen Einfluss auf den Umfang der Daten, die Tumblr mit Hilfe
        dieses Plugins erhebt und &uuml;bermittelt. Nach aktuellem Stand werden
        die IP-Adresse des Nutzers sowie die URL der jeweiligen Webseite
        &uuml;bermittelt.
      </p>{' '}
      <p>
        Weitere Informationen hierzu finden sich in der
        Datenschutzerkl&auml;rung von Tumblr unter{' '}
        <a href="http://www.tumblr.com/policy/de/privacy">
      ...
      <p>&nbsp;</p> <h2>Kommentarfunktion auf dieser Webseite</h2>{' '}
      <p>
      ...
      <p>
        Als Nutzer der Seite k&ouml;nnen Sie nach einer Anmeldung Kommentare
        abonnieren. Sie erhalten eine Best&auml;tigungsemail, um zu pr&uuml;fen,
        ob Sie der Inhaber der angegebenen E-Mail-Adresse sind. Sie k&ouml;nnen
        diese Funktion jederzeit &uuml;ber einen Link in den Info-Mails
        abbestellen.
      </p>{' '}
      ...
      <p>
        ...
        die Sie an uns als Seitenbetreiber senden, eine SSLVerschl&
        uuml;sselung. Eine verschl&uuml;sselte Verbindung erkennen Sie daran,
      ...
      <p>&nbsp;</p> <h2>Auskunft, L&ouml;schung, Sperrung</h2>{' '}
      <p>
      ...
      <p>&nbsp;</p> <h2>Widerspruch Werbe- Mails</h2>{' '}
      <p>
